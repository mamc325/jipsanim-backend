...
| 4차 | `specs/004-outbox-notification` | Outbox Pattern(동일 커밋 적재·폴링 Worker), Mock 알림 비동기 처리, 지수 백오프 재시도·DEAD 격리·수동 재처리 | **설계 완료**(spec/plan/data-model/contracts/tasks, 구현 대기) |
